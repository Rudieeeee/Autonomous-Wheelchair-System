...
class CmdVelToJoystick(Node):
    def __init__(self):
        ...
        # until /amcl_pose covariance is low enough.
        ...
        # If AMCL is older than this, normal movement is blocked.
        ...
        self.declare_parameter("amcl_block_joystick_x", 64)
    ...
    def timer_callback(self):
        ...
        #
        # If AMCL is accurate:
        #   allow normal Nav2 /cmd_vel -> /joystick_cmd
        #
        # If AMCL is uncertain:
        #   if full scan is clear:
        #       send [64, 0]
        #   else:
        #       send [0, 0]
        if not self.amcl_allows_movement():
            if self.obstacle_allows_recovery_movement():
                self.current_x = self.amcl_block_joystick_x
                self.current_y = self.amcl_block_joystick_y
